...
from fabriks.stores import get_range_bytes, join

if TYPE_CHECKING:  # pragma: no cover - typing only
    from fabriks.reader import CellEntry, Collection
...
def _boundary_vertices_survive_decimation(collection: Collection) -> Check:
    ...
    **It is one step in two different units, and they must not be swapped.** Deciding whether a
    ...
    voxel figure to :func:`~fabriks.geometry.on_planes` multiplies the tolerance by the extent --
