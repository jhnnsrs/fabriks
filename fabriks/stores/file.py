...
from fabriks.stores.access import get_range_bytes
...
class StoreFile:
    ...
    lands on :func:`fabriks.stores.access.get_range_bytes`.
    ...
    **It can also be filled from outside**, with :meth:`prime`. pyarrow's reader is synchronous
    ...
    #: into one; 64 KiB covers the footer of any part fabriks writes.
    TAIL_BYTES = 64 * 1024

    def __init__(self, store: FabriksStore, path: str, size: int) -> None:
