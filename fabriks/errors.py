"""The errors fabriks raises, named so a caller can tell a bug from a missing dependency."""

from __future__ import annotations


class FabriksError(Exception):
    """Base class for every error fabriks raises."""


class MissingExtraError(FabriksError, ImportError):
    """An optional dependency is needed for what was asked and is not installed."""


class FormatError(FabriksError, ValueError):
