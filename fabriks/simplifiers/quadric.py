...
fast-simplification is a dependency of fabriks rather than an extra -- making coarse levels is
what fabriks is for -- so it is imported plainly here.
"""
...
from fabriks.simplifiers.greedy import GreedyEdgeCollapse
...
class QuadricSimplifier:
    ...
    **What this costs, stated plainly.** ``preserve_border`` is all-or-nothing: it pins the
    ...
    :class:`~fabriks.simplifiers.greedy.GreedyEdgeCollapse` -- which pins only *this* level's cell
    planes -- reached 9%.
