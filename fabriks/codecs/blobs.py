...
from fabriks.codecs.meshopt import MeshoptCodec
from fabriks.codecs.protocol import BlobCodec
from fabriks.codecs.raw import RawCodec
from fabriks.errors import FormatError, PartitioningError
from fabriks.manifest import CODEC_MESHOPT, CODEC_NONE, COMPRESSION_NONE
from fabriks.octree import cell_box

#: The quantization denominator. Note it is **odd**, which is the whole reason
#: :func:`fabriks.geometry.snap_boundary` exists.
QUANT_MAX = 65535
